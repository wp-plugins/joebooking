...
'appointments'	=> array(
	'customer'	=> array(
		...
		array( 'appointment-showup-customer',			M('Appointment') . ': ' . M('Unmark No Show') ),
	...
	'provider'	=> array(
		...
		array( 'appointment-reassign_from-provider',	M('Appointment') . ': ' . M('Reassign From') ),
		array( 'appointment-reassign_to-provider',		M('Appointment') . ': ' . M('Reassign To') ),
		array( 'appointment-noshow-provider',			M('Appointment') . ': ' . M('No Show') ),
		array( 'appointment-showup-provider',			M('Appointment') . ': ' . M('Unmark No Show') ),

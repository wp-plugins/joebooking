...
class HC_Validator
{
	...
	public function error($field = '')
	{
		...
		{
			$return = array();
			$keys = array_keys( $this->_field_data );
			foreach( $keys as $k )
			{
				if( $this_error = $this->error($k) )
				{
					$return[ $k ] = $this_error;
				}
			}
	 ...
	 *
	 * @access	public
	 * @param	array the data to check
	 * @return	bool
	 */
	public function run( $post = array() )
	{
